...
class RateLimiter:
    ...
    def can_make_request(self, estimated_tokens: int = 1000) -> Tuple[bool, Optional[float]]:
        ...
        with self._lock:
            ...
            token_wait = 0.0 if can_consume_tokens else self.token_bucket.time_until_tokens(estimated_tokens)
    ...
    async def wait_for_capacity(self, estimated_tokens: int = 1000, max_wait: float = 300.0) -> None:
