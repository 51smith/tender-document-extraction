...
from app.services.llm_service import GeminiLLMService, OpenAILLMService, OllamaLLMService
...
class TestErrorRecoveryMetrics:
    ...
    async def test_error_logging_during_retries(self):
        ...
        with patch('asyncio.sleep'), \
             patch('app.core.retry_config.logger') as mock_logger:
