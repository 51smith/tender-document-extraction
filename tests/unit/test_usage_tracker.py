...
class TestUsageTracker:
    ...
    async def test_record_usage_success(self, usage_tracker, mock_redis):
        ...
        with patch.object(usage_tracker, '_store_usage_event') as mock_store, \
             patch.object(usage_tracker, '_update_metrics') as mock_update, \
             patch.object(usage_tracker, '_check_cost_alerts') as mock_alerts:
