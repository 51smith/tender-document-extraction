...
class TestHealthRouterCoverage:
    ...
    def test_detailed_health_prompt_builder_exception_lines_80_82(
        ...
        from unittest.mock import MagicMock
        mock_prompt_builder.get_available_templates = MagicMock(side_effect=Exception("Templates failed"))
    ...
    def test_llm_health_exception_lines_116_118(
        self, test_client, mock_gemini_client
    ):
    ...
    def test_redis_health_success_line_136(
        self, test_client, mock_job_manager
    ):
    ...
    def test_readiness_exception_line_170(
        self, test_client, mock_gemini_client, mock_job_manager
    ):
    ...
    def test_readiness_success_line_175(
        self, test_client, mock_gemini_client, mock_job_manager
    ):
