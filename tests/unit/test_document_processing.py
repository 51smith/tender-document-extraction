...
class TestDocumentProcessor:
    ...
    def test_unsupported_format_error(self):
        ...
        # Create content that can't be decoded as UTF-8 and has no recognizable magic bytes
        # Using invalid UTF-8 byte sequence
        unknown_content = b"\xff\xfe\x00\x00\x80\x81\x82\x83"
    ...
    def test_multimodal_content_preparation(self):
        ...
        doc_content = DocumentContent(
            ...
            images=[
                {"filename": "image1.jpg", "content_type": "image/jpeg", "data": b"fake_image_data"}
            ],
            tables=[],
            metadata={},
