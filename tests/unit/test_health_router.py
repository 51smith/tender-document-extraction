...
def mock_gemini_client():
    ...
    mock.get_usage_stats = Mock(return_value={"requests_today": 100, "tokens_used": 5000})
    return mock
...
class TestDetailedHealthCheck:
    ...
    def test_detailed_health_all_services_healthy(self, override_dependencies, sync_client):
...
class TestHealthCheckErrorHandling:
    ...
    def test_detailed_health_llm_exception(
        ...
        mock_gemini_client.test_connection = AsyncMock(
            side_effect=Exception("LLM service connection failed")
        )
    ...
    def test_detailed_health_redis_exception(
        ...
        mock_prompt_builder.get_available_templates = AsyncMock(return_value=["default"])
    ...
    def test_detailed_health_prompt_builder_exception(
        ...
        mock_gemini_client.test_connection.return_value = {"status": "success"}
        mock_job_manager.get_job_statistics = AsyncMock(return_value={"total_jobs": 100})
        mock_get_gemini_client.return_value = mock_gemini_client
        mock_get_job_manager.return_value = mock_job_manager
        mock_get_prompt_builder.return_value = mock_prompt_builder
        ...
        mock_prompt_builder.get_available_templates = AsyncMock(
    ...
    def test_detailed_health_multiple_services_unhealthy(
        ...
        mock_prompt_builder.get_available_templates = AsyncMock(
            side_effect=Exception("Templates unavailable")
        )
...
class TestLLMHealthCheck:
    ...
    def test_llm_health_check_success(self, sync_client, mock_gemini_client):
        """Test LLM health check success."""
        # Setup mock return values
    @patch("app.routers.health.get_gemini_client")
    def test_llm_health_check_success(
        self, mock_get_gemini_client, sync_client, mock_gemini_client
    ):
        """Test LLM health check success."""
        # Setup
        mock_get_gemini_client.return_value = mock_gemini_client
    ...
    @patch("app.routers.health.get_gemini_client")
    def test_llm_health_check_non_gemini_provider(
        self, mock_get_gemini_client, sync_client, mock_gemini_client
    ):
    ...
    def test_llm_health_check_failure(self, sync_client, mock_gemini_client):
    ...
    def test_llm_health_check_exception(self, sync_client, mock_gemini_client):
    ...
    @patch("app.routers.health.get_gemini_client")
    def test_llm_health_check_exception(
        self, mock_get_gemini_client, sync_client, mock_gemini_client
    ):
        """Test LLM health check with exception (lines 116-125)."""
        # Setup
...
class TestRedisHealthCheck:
    ...
    def test_redis_health_check_success(self, sync_client, mock_job_manager):
    ...
    def test_redis_health_check_failure(self, sync_client, mock_job_manager):
    ...
    def test_redis_health_check_empty_statistics(self, sync_client, mock_job_manager):
    ...
    @patch("app.routers.health.get_job_manager")
    def test_redis_health_check_empty_statistics(
