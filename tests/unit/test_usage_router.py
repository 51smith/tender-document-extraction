...
class TestCurrentUsage:
    ...
    def test_get_current_usage_success(
        self, sync_client, mock_usage_tracker, sample_usage_metrics
    ):
...
class TestModelUsage:
    ...
    def test_get_model_usage_success(
        self, sync_client, mock_usage_tracker, sample_model_breakdown
    ):
    ...
    def test_get_model_usage_empty(
        self, sync_client, mock_usage_tracker
    ):
...
class TestUsageHistory:
    ...
    def test_get_usage_history_default(
...
class TestUsageReset:
    ...
    def test_reset_usage_metrics_success(
        self, sync_client, mock_usage_tracker
    ):
    ...
    def test_reset_usage_metrics_no_confirmation(
        self, sync_client, mock_usage_tracker
    ):
...
class TestDetailedUsage:
    ...
    def test_get_detailed_usage_success(
        self, sync_client, mock_usage_tracker, mock_gemini_client, 
        sample_usage_metrics, sample_model_breakdown
    ):
        ...
        mock_usage_tracker.get_model_usage_breakdown = AsyncMock(return_value=sample_model_breakdown)
        mock_gemini_client.get_usage_stats = AsyncMock(return_value={
    ...
    def test_get_detailed_usage_error(
        self, sync_client, mock_usage_tracker, mock_gemini_client
    ):
...
class TestCostAnalysis:
    ...
    def test_get_cost_analysis_success(
        self, sync_client, mock_usage_tracker, sample_usage_history
    ):
    ...
    def test_get_cost_analysis_no_data(
        self, sync_client, mock_usage_tracker
    ):
...
class TestCostRecommendations:
    ...
    def test_generate_cost_recommendations_low_cost(self):
        ...
        recommendations = _generate_cost_recommendations(avg_daily_cost=2.0, avg_cost_per_request=0.1)
    ...
    def test_generate_cost_recommendations_high_daily_cost(self):
        ...
        recommendations = _generate_cost_recommendations(avg_daily_cost=15.0, avg_cost_per_request=0.2)
    ...
    def test_generate_cost_recommendations_high_per_request_cost(self):
        ...
        recommendations = _generate_cost_recommendations(avg_daily_cost=5.0, avg_cost_per_request=0.75)
    ...
    def test_generate_cost_recommendations_very_high_cost(self):
        ...
        recommendations = _generate_cost_recommendations(avg_daily_cost=60.0, avg_cost_per_request=0.8)
